           ...
           _protocol.addZephyrPacketEventListener(new ZephyrPacketListener() {
               ...
               public void ReceivedPacket(ZephyrPacketEvent eventArgs) {
                   ...
                   byte RcvdBytes;
                       ...
                       //0x20 General Data (streaming) Packet
                   if (msg.getMsgID() == 32)
                   {
                       // First Part: 128 -> mod 128?, Second Part: ==128 -> 0, >< 128 -> 128
                       ...
                       int byte9 =	DataBytes[9]&0xFF; //Heart Rate-LS Byte
                       int byte10 = DataBytes[10]&0xFF; //Heart Rate-MS Byte
                       //if ((seq % 11) == 0)
                       //{
                       ...
                       *****************************/
                       ...
                       b1.putString("heartRate", String.valueOf(GPInfoPacket.GetHeartRate(msg.getBytes())));
                       b1.putString("respirationRate", String.valueOf(GPInfoPacket.GetRespirationRate(msg.getBytes())));
